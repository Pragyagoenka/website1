      ...
      for (var i = 0; i < shapes.length; i++) {
        if (j !== i) {
          ...
          if (dist <= lessThan) {
            ...
            ctx.strokeStyle = 'hsl(' + this.c + ', 0%,' + ' 10%)';
            ctx.beginPath();
...
function myFunction() {
  ...
  document.getElementById("myBar1").style.width = scrolled + 0 + "%";
  document.getElementById("myBar2").style.width = scrolled + 0 + "%";
  document.getElementById("myBar3").style.width = scrolled - 40 + "%";
  document.getElementById("myBar4").style.width = scrolled - 40 + "%";
